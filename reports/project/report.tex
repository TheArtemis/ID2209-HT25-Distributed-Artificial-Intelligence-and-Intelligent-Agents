...
\begin{enumerate}[leftmargin=*]
  ...
  \end{figure}
  \item \textbf{Interpretation: } Initially, Q-values are zero and all agents are randomly exploring all trade suggestions.
  ...
  \item \textbf{Screenshot:}
    ...
    \label{fig:avgtrust}
  \end{figure}
  \item \textbf{Interpretation:} The learning system has successfully evolved. Agents have developed strong negative trust toward parasites and positive trust toward cooperative agents. This continuous improvement can be seen in \ref{fig:avgtrust} Adaptive curiosity has adjusted to 10-15\% exploration since agents are now successful (high average trust).
  ...
  \item \textbf{Screenshot:}
    ...
    \label{fig:lifespans}
  \end{figure}
  \item \textbf{Interpretation:} As shown in \ref{fig:lifespans}, the average lifespan of living agents increases over time, while the average lifespan of deceased agents stabilizes. This indicates that agents are successfully avoiding parasites, leading to longer survival times for cooperative agents.
\end{enumerate}
