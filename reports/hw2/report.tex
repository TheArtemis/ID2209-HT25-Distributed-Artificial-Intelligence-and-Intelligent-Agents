...
All auctioneers sell the same products to guests; alcohol, sugar and ashtonishings (they in a bit recall the environment of a techno music festival).
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{collect_proposals.png}
