...
can three independent auctions simultaneously (alcohol, sugar, magic_crystals) 
using vectorized state management and separate reflexes per item.
All auction state is stored in lists indexed by item (0=alcohol, 1=sugar, 2=magic_crystals). This is done because
